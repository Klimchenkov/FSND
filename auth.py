...
'''
AuthError Exception
A standartdized way to communicate auth failure modes
'''
...
'''
    get_token_auth_header() method attempts to get the header from the request
...
check_permissions(permission,payload) method
    ...
    it raises an AuthError if permissions are not incluses in the payload
